...
module SEPA
  class Transaction
    ...
    attr_accessor :name, :iban, :bic, :amount, :instruction, :reference, :remittance_information, :remittance_reference, :requested_date, :batch_booking, :currency, :postal_address, :creditor_bank_postal_address
