      ...
      when PAIN_001_001_03_CH_02
        ...
        when '1'
          valid_base &&
            ...
            self.iban.nil? && self.ch_postal_account.nil? && self.ch_isr_participation_number.present? && self.remittance_reference.present? && self.bic.nil? &&
            self.ch_bank_postal_account.nil? && self.creditor_bank_name.nil? && self.ch_code_line.nil?
        when '2.1'
          valid_base &&
            self.ch_local_instrument == 'CH02' &&
            self.iban.nil? && self.ch_postal_account.present? && self.ch_isr_participation_number.nil? && [nil, 'NOTPROVIDED'].include?(self.remittance_reference) && self.bic.nil? &&
            self.ch_bank_postal_account.nil? && self.creditor_bank_name.nil? && self.ch_code_line.nil?
        when '2.2'
          valid_base && self.ch_isr_participation_number.nil? &&
            ...
            ((self.ch_postal_account.nil? && self.clearing_number.present? && self.ch_bank_postal_account.nil? && self.creditor_bank_name.nil?) || # V1
              (self.ch_postal_account.nil? && self.clearing_number.present? && self.ch_bank_postal_account.present? && self.creditor_bank_name.nil?) || # V2
              (self.ch_postal_account.nil? && self.clearing_number.nil? && self.ch_bank_postal_account.present? && self.creditor_bank_name.present?)) # V3
        when '3', nil
          valid_base &&
