      ...
      when PAIN_001_001_03_CH_02
        ...
        when '2.1'
          valid_base &&
            ...
            self.iban.nil? && self.ch_postal_account.present? && self.ch_isr_participation_number.nil? && [nil, 'NOTPROVIDED'].include?(self.reference) && self.bic.nil? &&
            self.ch_bank_postal_account.nil? && self.creditor_bank_name.nil? && self.ch_code_line.nil?
        when '2.2'
          IBANValidator.new.validate(self) if (self.iban.present? && self.ch_bank_account.nil? && self.ch_code_line.nil?)
        ...
        when '3', nil
          IBANValidator.new.validate(self)
